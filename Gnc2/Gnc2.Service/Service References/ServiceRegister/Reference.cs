...
namespace Gnc2.Service.ServiceRegister {
    ...
    [System.ServiceModel.ServiceContractAttribute(ConfigurationName="ServiceRegister.IPermissionQueryService")]
    public interface IPermissionQueryService {
        ...
        Gnc2.Service.ServiceRegister.PermissionQueryResult GetServicePermission(string msisdn);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IPermissionQueryService/GetServicePermission", ReplyAction="http://tempuri.org/IPermissionQueryService/GetServicePermissionResponse")]
        System.Threading.Tasks.Task<Gnc2.Service.ServiceRegister.PermissionQueryResult> GetServicePermissionAsync(string msisdn);
        ...
        Gnc2.Service.ServiceRegister.PermissionQueryResult WriteServicePermission(string msisdn, Gnc2.Service.ServiceRegister.Permission permission);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IPermissionQueryService/WriteServicePermission", ReplyAction="http://tempuri.org/IPermissionQueryService/WriteServicePermissionResponse")]
        System.Threading.Tasks.Task<Gnc2.Service.ServiceRegister.PermissionQueryResult> WriteServicePermissionAsync(string msisdn, Gnc2.Service.ServiceRegister.Permission permission);
    }
    
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public interface IPermissionQueryServiceChannel : Gnc2.Service.ServiceRegister.IPermissionQueryService, System.ServiceModel.IClientChannel {
    }
    
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public partial class PermissionQueryServiceClient : System.ServiceModel.ClientBase<Gnc2.Service.ServiceRegister.IPermissionQueryService>, Gnc2.Service.ServiceRegister.IPermissionQueryService {
        ...
        public Gnc2.Service.ServiceRegister.PermissionQueryResult GetServicePermission(string msisdn) {
            return base.Channel.GetServicePermission(msisdn);
        }
        
        public System.Threading.Tasks.Task<Gnc2.Service.ServiceRegister.PermissionQueryResult> GetServicePermissionAsync(string msisdn) {
            return base.Channel.GetServicePermissionAsync(msisdn);
        }
        
        public Gnc2.Service.ServiceRegister.PermissionQueryResult WriteServicePermission(string msisdn, Gnc2.Service.ServiceRegister.Permission permission) {
            return base.Channel.WriteServicePermission(msisdn, permission);
        }
        
        public System.Threading.Tasks.Task<Gnc2.Service.ServiceRegister.PermissionQueryResult> WriteServicePermissionAsync(string msisdn, Gnc2.Service.ServiceRegister.Permission permission) {
